<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="JudgingForms.aspx.cs" Inherits="WMTA.Reporting.JudgingForms" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        ...
        <div>
            <div class="text-align-center"><h3 class="center">Keyboard Judging Form</h3></div>
            <rsweb:ReportViewer ID="rptKeyboardForm" runat="server" CssClass="report-viewer"></rsweb:ReportViewer>
        </div>
        <div>
