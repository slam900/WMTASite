<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="StudentResultReports.aspx.cs" Inherits="WMTA.Reporting.StudentResultReports" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-md-12">
        <div>
            <div class="text-align-center"><h3>District Student Results</h3></div>
            <rsweb:ReportViewer ID="rptResults" runat="server" CssClass="report-viewer"></rsweb:ReportViewer>
        </div>
        <div>
            <div class="text-align-center"><h3 class="center">Out of District Student Results</h3></div>
            <rsweb:ReportViewer ID="rptOutOfDistrictResults" runat="server" CssClass="report-viewer"></rsweb:ReportViewer>
        </div>
    </div>
    <script>
