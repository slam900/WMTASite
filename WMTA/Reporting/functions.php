...
genesis_register_sidebar( array(
	'id'          => 'home-widgets-1',
	'name'        => __( 'Home 1 - Feature', 'centric' ),
	'description' => __( 'This is the first section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-2',
	'name'        => __( 'Home 2 - Connection', 'centric' ),
	'description' => __( 'This is the second section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-3',
	'name'        => __( 'Home 3 - BYBB Intro', 'centric' ),
	'description' => __( 'This is the third section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-4',
	'name'        => __( 'Home 4 - More Intro', 'centric' ),
	'description' => __( 'This is the fourth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-5',
	'name'        => __( 'Home 5 - First Buy Now', 'centric' ),
	'description' => __( 'This is the fifth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-6',
	'name'        => __( 'Home 6 - Modules', 'centric' ),
	'description' => __( 'This is the sixth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-7',
	'name'        => __( 'Home 7 - Bonuses', 'centric' ),
	'description' => __( 'This is the seventh section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-8',
	'name'        => __( 'Home 8 - For You If...', 'centric' ),
	'description' => __( 'This is the eighth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-9',
	'name'        => __( 'Home 9 - Buy Now 2', 'centric' ),
	'description' => __( 'This is the ninth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-10',
	'name'        => __( 'Home 10' - About Me', 'centric' ),
	'description' => __( 'This is the tenth section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-11',
	'name'        => __( 'Home 11 - FAQ', 'centric' ),
	'description' => __( 'This is the eleventh section of the home page.', 'centric' ),
) );
genesis_register_sidebar( array(
	'id'          => 'home-widgets-12',
	'name'        => __( 'Home 12 - Guarantee', 'centric' ),
	'description' => __( 'This is the twelfth section of the home page.', 'centric' ),
) );
