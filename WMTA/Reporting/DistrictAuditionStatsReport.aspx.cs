...
{
    public partial class DistrictAuditionStatsReport : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (auditionOrgId != -1)
            {
                ...
                createReport("DistrictAuditionStatistics", rptStats, auditionOrgId);
            }
            else
            {
        ...
        private void createReport(string rptName, ReportViewer rptViewer, int auditionOrgId)
        {
            ...
            catch (Exception e)
            {
                ...
                Utility.LogError("DistrictAuditionStatsReport", "createReport", "rptName: " + rptName +
