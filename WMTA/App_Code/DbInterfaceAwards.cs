...
public partial class DbInterfaceAwards
{
     ...
     */
    public static DataTable GetAwardData(int year, int districtId, bool districtAudition)
    {
        ...
        {
            Utility.LogError("DbInterfaceAudition", "GetDistrictDataDump", "year: " + year + ", districtId: " + districtId + ", isDistrictAudition: " + districtAudition,
