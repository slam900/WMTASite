            ...
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <div class="form-group">
                        ...
                        <asp:GridView ID="gvContacts" runat="server" CssClass="td table table-hover table-striped smaller-font width-80 center" AllowPaging="true" AllowSorting="true" PageSize="50" PagerStyle-CssClass="bs-pagination" DataSourceID="SqlDataSource1"
