<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="BadgerSchedule.aspx.cs" Inherits="WMTA.Events.BadgerSchedule" %>
                            ...
                            <div class="well bs-component col-md-12 main-div center">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 center">
                                        <asp:GridView ID="gvSchedule" runat="server" AllowSorting="true" AutoGenerateColumns="true" CssClass="table table-bordered" RowStyle-Wrap="true" OnRowDataBound="gvSchedule_RowDataBound" />
                                    </div>
                                </div>
                            </div>
                        </ContentTemplate>
