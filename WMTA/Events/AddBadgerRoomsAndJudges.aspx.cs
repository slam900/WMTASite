...
{
    public partial class AddBadgerRoomsAndJudges : System.Web.UI.Page
    {
        ...
        private string roomsTable = "Rooms", judgesTable = "JudgesTable", judgeRoomsTable = "JudgeRoomsTable";
        private string judgeRooms = "JudgeRooms", auditionJudges = "AuditionJudges";
        ...
        */
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                Utility.LogError("AssignBadgerRoomsAndJudges", "btnSubmit_Click", "", "Message: " + ex.Message + "   Stack Trace: " + ex.StackTrace, -1);
            }
        }
        ...
        private void AddRoom(string room)
        {
            ...
            // Add the room to the judging rooms dropdown
         ...
         *       for a judge and displays a message, if necessary
        ...
        */
        ...
        protected void BindSessionData()
        {
            ...
            {
                Utility.LogError("AssignBadgerRoomsAndJudges", "BindSessionData", "", "Message: " + e.Message + "   Stack Trace: " + e.StackTrace, -1);
            }
        }
