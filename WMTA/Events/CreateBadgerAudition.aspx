                ...
                <asp:UpdatePanel ID="upFullPage" runat="server">
                    <ContentTemplate>
                        <div class="form-horizontal">
                            <fieldset>
                                <legend runat="server" id="legend">Add Badger Event</legend>
                                    ...
                                    <ContentTemplate>
                                        <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <asp:Button ID="btnAuditionSearch" runat="server" Text="Search" CssClass="btn btn-primary btn-min-width-72" OnClick="btnAuditionSearch_Click" />
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <asp:Button ID="btnClearAuditionSearch" runat="server" Text="Clear" CssClass="btn btn-default btn-min-width-72" />
                                            </div>
                                            <div class="form-group">
