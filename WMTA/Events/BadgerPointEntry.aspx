<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="BadgerPointEntry.aspx.cs" Inherits="WMTA.Events.BadgerPointEntry" %>
                ...
                <asp:UpdatePanel ID="upFullPage" runat="server">
                    <ContentTemplate>
                        <div class="form-horizontal">
                            <%-- Start of form --%>
                            <fieldset>
                                <legend>Badger Point Entry</legend>
                                <%-- Student search --%>
