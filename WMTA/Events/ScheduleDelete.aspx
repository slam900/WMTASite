<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/MasterPage.Master" AutoEventWireup="true" CodeBehind="ScheduleDelete.aspx.cs" Inherits="WMTA.Events.ScheduleDelete" %>
                    ...
                    <asp:UpdatePanel ID="upViewSchedule" runat="server" Visible="false">
                        <ContentTemplate>
                            <div class="well bs-component col-md-12 main-div center">
                                <h4><asp:Label ID="lblAudition" runat="server" /><asp:Label runat="server" ID="lblAuditionId" Visible="false" /></h4>
                                <h4><asp:Label ID="lblAudition2" runat="server" Visible="false" /></h4>
                                <div class="form-group">
                                    <asp:Button ID="btnDelete" Text="Delete Schedule" runat="server" CssClass="btn btn-primary float-right margin-right-15px" OnClick="btnDelete_Click" />
                                </div>
                                <div class="form-group">
