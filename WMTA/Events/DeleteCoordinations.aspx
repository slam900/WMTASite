                                ...
                                <ContentTemplate>
                                    <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <asp:DropDownList ID="ddlAuditionType" runat="server" CssClass="dropdown-list form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlAuditionType_SelectedIndexChanged">
                                    ...
                                    <div class="form-group">
                                        <asp:Table ID="tblCoordinates" runat="server" CssClass="table table-striped table-bordered table-hover text-align-center">
                                            <asp:TableHeaderRow ID="TableHeaderRow1" runat="server" BorderStyle="Solid">
                                                ...
                                                <%-- Checkbox --%>
                                                <asp:TableHeaderCell Scope="Column" Text="StudentId1" Visible="false" />
                                                <%-- Current student's id --%>
                                                <asp:TableHeaderCell Scope="Column" Text="StudentId2" Visible="false" />
                                                <%-- Coordinated student's id --%>
