                        ...
                        <asp:Panel runat="server" DefaultButton="btnSubmit">
                            <div class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" AssociatedControlID="ddlStyleSearch" CssClass="col-md-4 control-label float-left">Period</asp:Label>
                                        <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <asp:Label runat="server" AssociatedControlID="ddlStyleSearch2" CssClass="col-md-4 control-label float-left">Period</asp:Label>
                                        <div class="col-md-8">
